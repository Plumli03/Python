color_list = ['snow', 'ghost white', 'white smoke', 'gainsboro', 'floral white', 'old lace',
              ...
              'gray93', 'gray94', 'gray95', 'gray97', 'gray98', 'gray99', 'white', 'white', 'white', 'white',
              'white']  # 479+5

def square(skk,x,y,w,h,colorname=None,r=0,g=0,b=0):
    '''  colorname='black'內定值
    ''' #doc.string 函式說明

    skk.penup()
    skk.goto( x,y )
    skk.setheading(0) #頭朝上
    skk.forward(w // 2)
    skk.right(90)
    skk.forward(h // 2)
    skk.setheading(90)
...
def circle(skk,x,y,radius,colorname=None,r=0,g=0,b=0): #圓在正左

    skk.penup()
    skk.goto( x,y )
    skk.setheading(0) #0朝右 90頭朝上
    skk.forward(radius)
    skk.setheading(90)
    skk.pendown()
